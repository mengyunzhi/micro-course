<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\xampp\htdocs\thinkphp5\public/../application/index\view\admin_student\index.html";i:1602932422;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                        ...
                        <div class="col-md-8">
                            <form class="form-inline">
                                <div class="form-group">
                                    <label class="sr-only" for="num">姓名</label>
