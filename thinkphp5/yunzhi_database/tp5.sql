...
CREATE TABLE `yunzhi_seat`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 241579 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = FIXED;
...
CREATE TABLE `yunzhi_seat_aisle`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 243160 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = FIXED;
...
CREATE TABLE `yunzhi_term`  (
  ...
  `ftime` int(11) NOT NULL COMMENT '学期截止时间',
