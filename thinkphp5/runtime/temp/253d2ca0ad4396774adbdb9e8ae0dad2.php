<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\xampp\htdocs\thinkphp5\public/../application/index\view\admin_student\edit.html";i:1604581649;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    ...
    <div class="container">
        <form action="<?php echo url('update'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="num" id="num" class="form-control" value="<?php echo $Student->num; ?>" />
            </div>
            <div class="form-group">
                ...
                <input type="checkbox" name="course_id[]" id="course_id_<?php echo $course->id; ?>" value="<?php echo $course->id; ?>" <?php if($Student->getIsChecked($course) == 'true'): ?>checked="checked" <?php endif; ?>/> <label for="course_id_<?php echo $course->id; ?>"><?php echo $course->name; ?></label>
