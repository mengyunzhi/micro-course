<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"D:\xampp\htdocs\micro-course\thinkphp5\public/../application/index\view\admin_teacher\index.html";i:1608687529;s:82:"D:\xampp\htdocs\micro-course\thinkphp5\public/../application/index\view\index.html";i:1608540289;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<table class="table table-hover table-bordered">
    ...
    <tr>
        ...
        <td>
            ...
            <a class="btn btn-success btn-sm" href="<?php echo url('AdminCourse/index?id=' . $teacher->getData('id')); ?>">&nbsp;所教课程</a>
            <a class="btn btn-danger btn-sm" href="<?php echo url('AdminCourse/index?id=' . $teacher->getData('id')); ?>"><i class="glyphicon glyphicon-trash"></i>&nbsp;删除</a>&nbsp;
        </td>
    </tr>
